...
module.exports = {
  ...
  plugins: [
    ...
    new FusesPlugin({
      ...
      [FuseV1Options.EnableEmbeddedAsarIntegrityValidation]: false, // Desabilitado temporariamente
      [FuseV1Options.OnlyLoadAppFromAsar]: false, // Desabilitado temporariamente
    }),
  ],
};
